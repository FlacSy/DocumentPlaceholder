...
class YamlHighlighter(_Highlighter):
    ...
    TAGS = [
        "hl_number", "hl_boolean", "hl_list_marker", "hl_key",
        "hl_comment", "hl_special_key", "hl_string", "hl_function",
        "hl_brace",
    ]
    PRIORITY = TAGS
...
class SqlHighlighter(_Highlighter):
    ...
    TAGS = [
        "hl_operator", "hl_number", "hl_keyword",
        "hl_comment", "hl_string", "hl_function",
    ]
    PRIORITY = TAGS
